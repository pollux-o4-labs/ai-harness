...
def test_vgo_managed_block_also_exempt_from_line_budget(real_forms):
...
def test_vgo_managed_block_exempt_from_prose_rules(real_forms):
...
def test_marker_quoted_in_prose_does_not_open_a_block(real_forms):
...
def test_crossed_autogen_markers_fail_toward_stricter(real_forms):
