...
- `line_shapes.py` — 산문 형태(shape) 판정 — 펜스·문장 경계·체크박스·이슈 참조·예산 파싱 문법(stdlib only, 의존성 0) — check_doc_form.py·check_pr_body.py·relink_docs.py·gate_config.py가 순환 임포트 없이 공유하는 leaf 모듈.
