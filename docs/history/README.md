...
- `B-color-codes-made-a-guard-skip-silently.md` — ANSI 색 코드가 경로 탐지를 무효화해 유일한 감시 장치가 묵인 건너뛰기로 통과했다.
...
- `G-no-refactor-owed-after-agents-common.md` — 새 코드를 훑고 고칠 스멜이 없다고 판정한 실측.
